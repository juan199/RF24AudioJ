...
#define SAMPLE_RATE 28000                     // The sample rate to use for transferring audio samples  Note: 44khz+ sample rate requires 8-bits per sample
...
/*********  Automated pin selections, override by defining above  ************/
  ...
  #define rampMega
    ...
    #define ledPin 13
  	...
  	#define speakerPin 3                        //The pins to output audio on. (9,10 on UNO,Nano)
  #endif
  #if !defined (speakerPin2)
	#define speakerPin2 9
  #endif
